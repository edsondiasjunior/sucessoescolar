...
export default function Hero() {
  return (
    <section className="container px-4 py-8 mx-auto flex flex-col gap-8 lg:flex-row items-center lg:px-8 lg:justify-between ">
      <div className="flex flex-col gap-12  ">
        ...
        <div className="flex flex-col items-center gap-4 lg:items-start">
          ...
          <p className="text-[1rem] text-center text-[var(--grey)] lg:text-start lg:max-w-2xl ">
        ...
        <div className="bg-[#e9ecf1] outline-8 outline-[#f2f4f7d0] rounded-full flex gap-8 items-center justify-center py-8 px-5 lg:rounded-l-3xl lg:rounded-r-full lg:max-w-[500px]">
          <div className="flex items-center gap-2">
            ...
            <p className="text-[var(--grey)] text-[.8rem]/tight lg:text-[1rem]/tight">Famílias ajudadas</p>
          </div>
          <div className="flex items-center gap-2">
            <h4 className="font-bold text-3xl text-[var(--pink)] lg:text-4xl">+13</h4>
            <p className="text-[var(--grey)] text-[.8rem]/tight">Anos de experiência</p>
          </div>
